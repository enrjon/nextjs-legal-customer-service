            ...
            <div className="bg-blue-900 md:bg-transparent flex flex-col justify-center px-[16px] py-[32px] gap-[24px] max-w-[650]">
                <div className="flex flex-col-reverse md:flex-col text-white">
                    <div className="flex flex-col ">
                        <h1 className="text-h3 font-bold text-center">We&apos;re more than an answering service</h1>
                        <p className="p text-b1">Answering Legal has everything you need to make sure your firm never misses another opportunity.</p>
                    </div>
